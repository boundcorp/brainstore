...
export default function FactoryPage() {
    ...
    const [title, setTitle] = useState("SuperContentMarketplace");
    useEffect(() => {
        const doAsync = async () => {
    ...
    const deploy = async () => {
        if(!factory.instance) {
            ...
            const tx = await factory.instance.createStoreBuilder(title, fee)
            setStatus("Deploying....")
            ...
            <div className="card">
                ...
                <form>
                    <div className='input-field'>
                        ...
                        <input type="text" className="input title" id='title' defaultValue={title} onChange={e => setTitle(e.target.value)}/>
                    </div>
                    <div className='input-field'>
                        ...
                        <input type="number" className="input fee" id='fee' defaultValue={fee} onChange={e => setFee(parseInt(e.target.value))}/>
                    </div>
                    <button className='button factory' onClick={deploy}>Deploy</button>
                </form>
            </div>
        </header>
    )
